...
class PostModel {
  ...
  ///
  /// **JPEG, never WebP**, for the same reason as [ProjectModel.ogCard]:
  /// LinkedIn and several other scrapers will not render a WebP `og:image`,
  /// so a `.webp` share card is indistinguishable from having none. The cover
  /// art here is a `.webp` and was doing exactly that.
  ///
  /// It is also not a crop of [coverImage]. Cover art is composed for the
  /// page, at the page's proportions; squeezing it into a 1.91:1 frame lands
  /// somewhere arbitrary. The card shows the title instead, which is the part
  /// worth reading in a feed. Generated by `tools/make-og-cards.py`.
  final String? ogCard;
